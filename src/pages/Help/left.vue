<template>
	...
	>
		<Submenu name="1">
			...
			<MenuItem name="Catalogue introduction">
				{{ $t('help_left_1_2') }}
			</MenuItem>
		...
		<Submenu name="2">
			...
			<MenuItem name="Basic components">
				{{ $t('help_left_2_1') }}
			</MenuItem>
			<MenuItem name="Decorating components">
				{{ $t('help_left_2_2') }}
			</MenuItem>
			<MenuItem name="Senior components">
				{{ $t('help_left_2_3') }}
			</MenuItem>
		</Submenu>
		<Submenu name="3">
		...
		<Submenu name="5">
			...
			<MenuItem name="Internationalization">
				{{ $t('help_left_5_2') }}
			</MenuItem>
		...
		<Submenu name="7">
			...
			<MenuItem name="Friendship sponsorship">
				{{ $t('help_left_7_1') }}
			</MenuItem>
