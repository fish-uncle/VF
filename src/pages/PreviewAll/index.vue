	...
	<div>
		<div class="text-center" :style="{marginTop: '10px'}">
			<Button type="primary"
					...
					@click="handleSubmit">{{$t('model_preview_submit')}}
			</Button>
			<Button type="primary"
					:style="{marginLeft: '10px'}"
					@click="handleReset">{{$t('model_preview_reset')}}
			</Button>
			<Button type="primary"
					:style="{marginLeft: '10px'}"
					@click="handleEdit">{{$t('model_preview_edit')}}
			</Button>
			<Button type="primary"
					:style="{marginLeft: '10px'}"
					@click="handleRead">{{$t('model_preview_read')}}
			</Button>
		</div>
...
<script>
	...
	export default {
				...
				result.push(
					{
						...
						widthRatio: 100,
						width: 12,
						type: 'form-select', componentType: 'Base',
		...
		mounted() {
			this.mockList()
			this.$store.commit('top/changeTop', {topIndex: 4})
		}
	}
</script>
